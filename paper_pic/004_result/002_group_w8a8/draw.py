...
RAW = r"""
    module.blocks.0.attn.qkv: 4
    module.blocks.0.attn.proj: 4
    module.blocks.0.mlp.fc1: 6
    module.blocks.0.mlp.fc2: 6
    module.blocks.1.attn.qkv: 12
    module.blocks.1.attn.proj: 12
    module.blocks.1.mlp.fc1: 8
    module.blocks.1.mlp.fc2: 12
    module.blocks.2.attn.qkv: 12
    module.blocks.2.attn.proj: 12
    module.blocks.2.mlp.fc1: 12
    module.blocks.2.mlp.fc2: 8
    module.blocks.3.attn.qkv: 12
    module.blocks.3.attn.proj: 8
    module.blocks.3.mlp.fc1: 12
    module.blocks.3.mlp.fc2: 12
    module.blocks.4.attn.qkv: 12
    module.blocks.4.attn.proj: 12
    module.blocks.4.mlp.fc1: 8
    module.blocks.4.mlp.fc2: 12
    module.blocks.5.attn.qkv: 8
    module.blocks.5.attn.proj: 12
    module.blocks.5.mlp.fc1: 12
    module.blocks.5.mlp.fc2: 12
    module.blocks.6.attn.qkv: 12
    ...
    module.blocks.8.attn.qkv: 12
    module.blocks.8.attn.proj: 12
    module.blocks.8.mlp.fc1: 12
    module.blocks.8.mlp.fc2: 12
    module.blocks.9.attn.qkv: 12
    module.blocks.9.attn.proj: 8
    module.blocks.9.mlp.fc1: 12
    module.blocks.9.mlp.fc2: 12
    module.blocks.10.attn.qkv: 12
    module.blocks.10.attn.proj: 12
    module.blocks.10.mlp.fc1: 6
    module.blocks.10.mlp.fc2: 8
    module.blocks.11.attn.qkv: 6
    module.blocks.11.attn.proj: 6
    module.blocks.11.mlp.fc1: 8
    module.blocks.11.mlp.fc2: 12
"""
...
plt.xticks(xs, [str(i+1) for i in xs])
...
plt.xticks(np.arange(L), [str(i+1) for i in range(L)])
plt.xlabel("Block index")
